...
// @Router /data/entity_extraction/{modelId} [post]
...
// @Produce json
// @Success 200 {string} message
// @Router /data/entity_extraction/{modelId} [delete]
...
// @Accept json
// @Produce json
// @Success 200 {object} helper.EntityDataPoints
// @Router /data/entity_extraction/{modelId} [get]
